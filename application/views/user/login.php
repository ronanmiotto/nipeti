  ...
  <html>
    ...
    <body>
      ...
      <div class="container">
          <img class="img-login" src="/assets/image/nipeti.jpg" alt=""width="150px">
          <div class="row">
              <form class="" action="/user/check_login" method="post">
                  <div class="col-md-offset-5 col-md-3">
                    ...
                    <a href="/user/create_session_for_user_visitant" class="btn btn-primary link-login-visitant">Acesso como visitante</a>
                  </div>
                </form>
                </div>
          </div>
